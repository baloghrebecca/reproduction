        ...
        return (<>
            <nav id="mobileNav" style={{ display: this.state.display, transform: this.state.top }}>
                ...
                <div id="mobileNestedNav">
                    <div>
                        <Link onClick={this.handleClickLink} activeClassName="activeMobile" to='/#booksWrapper'>BOOKS</Link>
            ...
            <header id="headerMainLandingPage" style={{ visibility: this.state.visibility }}>
                ...
                <nav id="navMain">
                    <Link activeClassName="active" to='/#headerMainLandingPage'>BOOKS</Link>,
